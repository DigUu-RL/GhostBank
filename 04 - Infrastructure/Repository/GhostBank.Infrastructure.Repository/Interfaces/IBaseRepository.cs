...
public interface IBaseRepository<TEntity> : IUnitOfWork where TEntity : EntityBase
{
	...
	Task<PaginatedList<TEntity>> GetAsync(Search<TEntity> search, bool readOnly = true);
	Task<PaginatedList<TEntity>> GetWithExcludedAsync(Search<TEntity> search, bool readOnly = true);
